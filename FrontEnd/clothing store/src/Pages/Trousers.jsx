...
// ── Product Data ────────────────────────────────────────────────
const ALL_PRODUCTS = [
  { id:1,  name:"Tito Men's Chino Pant",        basePrice:2295, sizes:[28,30,32,34,36],    inStock:true,  colors:["#f5f5f0","#111111","#1a3a5c"], img:"https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&q=82" },
  { id:2,  name:"Moose Chino Pant – Brick",      basePrice:3490, sizes:[30,32,34,36],       inStock:true,  colors:["#8b3a2a","#111111"],           img:"https://images.unsplash.com/photo-1548883354-94bcfe321cbb?w=600&q=82" },
  { id:3,  name:"Moose Chino Pant – Clay",       basePrice:3490, sizes:[28,30,32],          inStock:true,  colors:["#c4a882","#f5f5f0"],           img:"https://images.unsplash.com/photo-1594938298603-c8148c4b4a0c?w=600&q=82" },
  { id:4,  name:"Moose Chino – Steel Blue",      basePrice:3490, sizes:[32,34,36,38],       inStock:false, colors:["#4a6fa5","#f5f5f0","#111111"], img:"https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=600&q=82" },
  { id:5,  name:"Classic Slim Fit Trouser",      basePrice:2890, sizes:[28,30,32,34,36,38], inStock:true,  colors:["#111111","#f5f5f0","#1a3a5c"], img:"https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=600&q=82" },
  { id:6,  name:"Urban Cargo Trouser",           basePrice:3190, sizes:[30,32,34],          inStock:true,  colors:["#3d4a2e","#111111"],           img:"https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=600&q=82" },
  { id:7,  name:"Linen Blend Straight Trouser",  basePrice:2650, sizes:[28,30,32,34],       inStock:true,  colors:["#d4c5a9","#f5f5f0","#111111"], img:"https://images.unsplash.com/photo-1519058082700-08a0b56da9b4?w=600&q=82" },
  { id:8,  name:"Formal Tapered Trouser – Navy", basePrice:3990, sizes:[30,32,34,36,38,40], inStock:false, colors:["#1a3a5c","#111111"],           img:"https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?w=600&q=82" },
  { id:9,  name:"Stretch Slim Trouser – Black",  basePrice:3100, sizes:[30,32,34,36],       inStock:true,  colors:["#111111","#444444"],           img:"https://images.unsplash.com/photo-1560243563-062bfc001d68?w=600&q=82" },
  { id:10, name:"Relaxed Fit Chino – Olive",     basePrice:2450, sizes:[28,30,32,34,36],    inStock:true,  colors:["#6b7a3e","#f5f5f0"],           img:"https://images.unsplash.com/photo-1604644401890-0bd678c83788?w=600&q=82" },
  { id:11, name:"Premium Wool Blend Trouser",    basePrice:5490, sizes:[32,34,36,38],       inStock:true,  colors:["#888888","#111111","#1a3a5c"], img:"https://images.unsplash.com/photo-1603252109303-2751441dd157?w=600&q=82" },
  { id:12, name:"Cropped Chino – Sand",          basePrice:2190, sizes:[28,30,32],          inStock:false, colors:["#c4a882","#f5f5f0"],           img:"https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=600&q=82" },
  { id:13, name:"Wide Leg Trouser – Charcoal",   basePrice:3750, sizes:[30,32,34,36,38],    inStock:true,  colors:["#444444","#111111"],           img:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=82" },
  { id:14, name:"Slim Fit Chino – Camel",        basePrice:2895, sizes:[28,30,32,34],       inStock:true,  colors:["#c4a060","#f5f5f0","#111111"], img:"https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=600&q=82" },
  { id:15, name:"Tailored Trousers – Slate",     basePrice:4290, sizes:[32,34,36,38,40],    inStock:true,  colors:["#6e7f8d","#111111"],           img:"https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=600&q=82" },
  { id:16, name:"Jogger Style Trouser",          basePrice:2100, sizes:[28,30,32,34,36],    inStock:true,  colors:["#111111","#f5f5f0","#1a3a5c"], img:"https://images.unsplash.com/photo-1565084888279-aca607ecce0c?w=600&q=82" },
  { id:17, name:"Pintuck Trouser – Ecru",        basePrice:3350, sizes:[28,30,32,34,36,38], inStock:false, colors:["#ece8dc","#d4c5a9"],           img:"https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=600&q=82" },
  { id:18, name:"Performance Stretch Trouser",   basePrice:3690, sizes:[30,32,34,36],       inStock:true,  colors:["#111111","#1a3a5c","#444444"], img:"https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?w=600&q=82" },
  { id:19, name:"Corduroy Trouser – Burgundy",   basePrice:4100, sizes:[32,34,36,38],       inStock:true,  colors:["#6b2737","#111111"],           img:"https://images.unsplash.com/photo-1617196034779-5e0f1e7f5a0b?w=600&q=82" },
  { id:20, name:"Chino Shorts – Khaki",          basePrice:1890, sizes:[30,32,34,36],       inStock:true,  colors:["#b5a47a","#f5f5f0","#111111"], img:"https://images.unsplash.com/photo-1547496502-affa22d38842?w=600&q=82" },
];
    ...
    <div className="tr-modal-overlay" onClick={onClose}>
      <div className="tr-modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="tr-modal-info">
          ...
          {/* Colors */}
          <div>
            <div className="tr-modal-sizelbl">Available Colors</div>
    ...
    <aside className="tr-sidebar">
      ...
      <div className="tr-sb-sec">
        ...
        <div className="tr-sb-sizes">
          {ALL_SIZES.map((s) => (
            <button key={s} className={`tr-sb-sz ${selSize === s ? "active" : ""}`} onClick={() => setSelSize(selSize === s ? null : s)}>{s}</button>
          ))}
        </div>
      </div>
      <div className="tr-sb-sec">
    ...
    <div className="tr-pcard" onClick={() => onOpenModal(product)}>
      <div className="tr-imgw">
        ...
        <div className="tr-hicons">
          <button className={`tr-hico ${wished ? "liked" : ""}`} onClick={(e) => { e.stopPropagation(); setWished(!wished); }}><HeartIcon /></button>
      ...
      <div className="tr-pbody">
        ...
        {/* Size buttons — available = dark highlighted */}
...
export default function Trousers() {
  ...
  // Extra colors per product id (admin-added)
